             ...
             stories.map((story)=>(
               ...
               onClick={() => onStoryClick(story)}>
                <div className='flex flex-col gap-2 '>
                 ...
                 <img src={story.img} alt={story.name} className={`rounded-full h-26 w-26 object-cover ${story.viewed?"":"border-2 rounded-full bg-linear-to-r cursor-pointer from-blue-500 "}`}/>
                 </div>
