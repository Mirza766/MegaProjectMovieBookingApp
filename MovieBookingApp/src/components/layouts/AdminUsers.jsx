  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h2 className="text-2xl font-bold text-slate-100 tracking-tight">User Management</h2>
          <p className="text-slate-400 text-sm">Review, edit, or remove registered members from the system.</p>
        </div>
        <div className="bg-slate-900 border border-slate-800 px-4 py-2 rounded-lg text-sm text-slate-300">
          Total Users: <span className="text-blue-400 font-bold">{usersData.length}</span>
        </div>
      </div>
